                              ...
                              child: Column(
                                children: [
                                  ...
                                  Expanded(
                                    child: PieChart(
                                      PieChartData(
                                        startDegreeOffset: allOffers.isEmpty ? 0 : totalIncome,
                                        sectionsSpace: 0,
                                        sections: [
                                          PieChartSectionData(
                                            color: kPrimary1,
                                            value: acceptOffers.isEmpty ? 0 : accepted,
                                            showTitle: false,
                                          ),
                                          PieChartSectionData(
                                            color: kColorYellow,
                                            value: rejectedOffers.isEmpty ? 0 : rejected,
                                            showTitle: false,
                                          ),
                                          PieChartSectionData(
                                            color: kPrimary2,
                                            value: activeOffers.isEmpty ? 0 : active,
                                            showTitle: false,
                                          ),
                                        ],
                                      ),
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            width: 100,
                                            child: Text('Offered  $totalIncome'),
                                          ),
                                          const SizedBox(
                                            width: 7,
                                          ),
  ...
  Future getOffers() async {
    try {
      ...
      QuerySnapshot snapshot = await FirebaseFirestore.instance
          .collection('offers')
          .where('compnyId', isEqualTo: company.uid)
      ...
      if (snapshot.docs.isNotEmpty) {
        setState(() {
          ...
          for (var i in acceptOffers) {
            accepted += i.amount!;
          }
          for (var i in rejectedOffers) {
            rejected += i.amount!;
          }
